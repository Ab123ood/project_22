...
<div class="max-w-3xl mx-auto">
  <div class="flex items-center gap-4 mb-6">
    ...
    <h2 class="text-xl font-bold text-gray-900">Amending the survey</h2>
  </div>
    ...
    <form method="post" action="<?= $basePath ?>/admin/surveys/update" class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="text" name="category" value="<?= htmlspecialchars($survey['category'] ?? 'general') ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
        </div>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Availability of</label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Availability to</label>
      ...
      <div class="flex items-center gap-3">
        ...
        <label class="flex items-center text-sm text-gray-700">
          <input type="checkbox" name="anonymous" class="mr-2 w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" <?= $isAnon ? 'checked' : '' ?> />
          Anonymous survey
        </label>
      </div>

      <div class="flex items-center justify-between">
        <a href="<?= $basePath ?>/admin/surveys" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">cancellation</a>
