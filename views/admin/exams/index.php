...
<div class="flex items-center justify-between mb-6">
    <h2 class="text-xl md:text-2xl font-bold text-gray-900">إدارة الاختبارات</h2>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-900">قائمة الاختبارات</h3>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">المدة (د)</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php
                                    ...
                                    echo htmlspecialchars($difficultyLabels[$e['difficulty_level'] ?? 'beginner'] ?? 'مبتدئ');
                                ?>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2 space-x-reverse">
                                    <a class="text-blue-600 hover:text-blue-900 p-1" href="<?= $basePath ?>/admin/exams/questions?exam_id=<?= $e['id'] ?>" title="إدارة الأسئلة">
                                        <i class="ri-question-answer-line"></i>
                                    </a>
                                    <?php if ($isAdmin): ?>
                                    <a class="text-gray-600 hover:text-gray-900 p-1" href="<?= $basePath ?>/admin/exams/edit?id=<?= $e['id'] ?>" title="تعديل">
                                        <i class="ri-edit-line"></i>
                                    </a>
                                    <form method="POST" action="<?= $basePath ?>/admin/exams/delete" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا الاختبار؟')">
                                        <input type="hidden" name="exam_id" value="<?= $e['id'] ?>">
                                        <button type="submit" class="text-red-600 hover:text-red-900 p-1" title="حذف">
                ...
                <?php else: ?>
                    <tr>
                        <td class="px-6 py-6 text-center text-sm text-gray-500" colspan="6">لا توجد اختبارات حتى الآن.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
