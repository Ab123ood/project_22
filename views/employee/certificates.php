  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
      <div class="flex items-center gap-3 mb-4">
        ...
        <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Certificates and badges</h1>
      </div>
      <p class="text-gray-600">Show your accomplishments and certificates in the field of cybersecurity</p>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-5 border border-yellow-200">
        ...
        <div class="text-sm text-gray-600">Earned certificates</div>
      </div>
      ...
      <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border border-blue-200">
        ...
        <div class="text-sm text-gray-600">Achieved badges</div>
      </div>
      ...
      <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-5 border border-green-200">
        ...
        <div class="text-sm text-gray-600">Achievement rate</div>
      </div>
    ...
    <div class="grid lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2">
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-8">
          <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-semibold text-gray-900">My testimonies</h2>
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border border-blue-200 hover:shadow-lg transition-shadow">
              ...
              <div class="absolute top-4 left-4">
                ...
                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">Complete</span>
                <?php else: ?>
                <span class="px-2 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-full">Progress</span>
                <?php endif; ?>
              </div>
              ...
              <div class="text-center mt-8">
                ...
                <div class="text-sm text-gray-500 mb-4">
                  Date of achievement: <?= date('Y/m/d', strtotime($cert['completed_at'] ?? 'now')) ?>
                </div>
          ...
          <div class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-2">There are no certificates yet</h3>
            <p class="text-gray-600 mb-6">Start in completing the assessments and courses for your first certificates</p>
      ...
      <div class="lg:col-span-1">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
          <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-semibold text-gray-900">Slogans</h2>
            <span class="text-sm text-gray-500"><?= count($badges ?? []) ?> badge</span>
          </div>
          ...
          <div class="text-center py-8">
            ...
            <p class="text-sm text-gray-600">There are no achieved badges yet</p>
          </div>
          <?php endif; ?>

          <!-- Service offers -->
          <div class="mt-8 pt-6 border-t border-gray-200">
            <h3 class="font-semibold text-gray-900 mb-4">Next badges</h3>
            <div class="space-y-3">
              <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                  <div class="text-sm font-medium text-gray-900">Learning</div>
                  <div class="text-xs text-gray-500">Complete 10 consecutive lessons</div>
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                  <div class="text-sm font-medium text-gray-900">Security expert</div>
                  <div class="text-xs text-gray-500">I pass 5 Excellent assessments</div>
                  <div class="w-full bg-gray-200 rounded-full h-1 mt-1">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mt-8">
      ...
      <div class="space-y-4">
        <?php 
        $recentAchievements = [
          ['type' => 'certificate', 'title' => 'Cyber ​​security certificate', 'date' => '2024/01/15', 'points' => 100],
          ['type' => 'badge', 'title' => 'Outstanding beginner badge', 'date' => '2024/01/12', 'points' => 50],
          ['type' => 'exam', 'title' => 'E -hunting assessment - excellent degree', 'date' => '2024/01/10', 'points' => 75],
        ];
        ...
        <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
          ...
          <div class="flex-1">
            ...
            <div class="text-sm text-gray-500"><?= $achievement['date'] ?> • +<?= $achievement['points'] ?> a point</div>
          </div>
          <button class="text-primary hover:underline text-sm">an offer</button>
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('[data-action="share"]').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (navigator.share) {
                navigator.share({
                    title: 'My testimony in cybersecurity',
                    url: shareUrl
                });
            } else {
                navigator.clipboard.writeText(shareUrl).then(() => {
                    alert('The certificate link has been copied');
                });
            }
        });
    });
    ...
    document.querySelectorAll('.badge-item').forEach(badge => {
        badge.addEventListener('click', function() {
            ...
            // Can be added modal To view the emblem details
        });
    });
